...
class CarriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrier" do
    assert_difference('Carrier.count') do
      post carriers_url, params: { carrier: { carrier_type_id: @carrier.carrier_type_id, name: @carrier.name } }
    end
  ...
  test "should update carrier" do
    patch carrier_url(@carrier), params: { carrier: { carrier_type_id: @carrier.carrier_type_id, name: @carrier.name } }
